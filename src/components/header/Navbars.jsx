...
const Navbars = () => {
    ...
    return (
        <>
            <Box component={'div'} height={'3rem'} display={'flex'} sx={{ px: {xs:5,sm:10, md:15}, py: 2, boxShadow:{xs:'none', md:'0px 0px 10px rgba(0, 0, 0, 0.15)'} }} justifyContent={'space-between'} alignItems={'center'} position={{ md:'unset' }}>
