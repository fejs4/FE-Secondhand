...
import { deleteWishlist, fetchWishlist, postWishlist, setLoading } from "../../redux/wishlist";
                    ...
                    <Grid container my={1} p={1}>
                      ...
                      >
                        <Box
                          ...
                          src={`https://be-kel1.herokuapp.com/public/images/${res.product.images[0]}` }
                      ...
                      <Grid item xs={6} md={5}>
                        ...
                        <Typography
                          ...
                          fontSize={{ md: "1rem", xs: ".8rem" }}
                        >
                          {formatter.format(res.product.price)}
                        </Typography>
                      </Grid>
