...
const ListProductJual = () => {
  return (
    <>
        <Box p={2} sx={{boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.25)', borderRadius: '16px' }}>
            <Grid container rowSpacing={3} columnSpacing={{ xs: 3, sm: 3, md: 3 }} overflow='hidden' justifyContent={'start'}>
