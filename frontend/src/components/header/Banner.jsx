  ...
  return (
    <>
      <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'} width={'100%'} height={'288px'} mt={{ xs:0,md:3 }} mb={{ md:5, xs:-5 }} columnGap={3} top={{ md:'unset', xs:0 }} position={{ md:'unset', xs:'absolute'}} zIndex={{ md:'unset', xs:-1 }}>
        ...
        <Box width={'100%'} height={'288px'} display={'flex'} justifyContent={'space-between'} alignItems={'center'} sx={{ background:'#FFE9CA', borderRadius:{md:'20px', xs:'unset'} }}>
            <Box width={{ xs:'100%', md:'50%', lg:'50%' }} padding={5}>
            ...
            <Box width={'60%'} height={'288px'} position={'relative'} >
              ...
              <Box component={'img'} src='/images/banner/png_gift_88837.png' top={'25%'}  position={'absolute'}/>
            </Box>
        </Box>
